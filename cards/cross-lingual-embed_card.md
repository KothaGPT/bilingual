...
# Cross-lingual Embeddings (Bangla-English)

## Model Description

Generates aligned embeddings for Bangla and English text in shared semantic space.
...
model_name = "KothaGPT/cross-lingual-embed"
...
```bibtex
@misc{kothagpt-cross-lingual-embed,
  title={Cross-lingual Embeddings (Bangla-English)},
  author={KothaGPT Team},
  year={2024},
  publisher={Hugging Face},
  howpublished={\url{https://huggingface.co/KothaGPT/cross-lingual-embed}}
}
```
