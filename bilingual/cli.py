...
def main():
    ...
    tokenize_parser.add_argument("--tokenizer", default="bilingual-tokenizer", help="Tokenizer model name")
    tokenize_parser.add_argument("--ids", action="store_true", help="Return token IDs instead of strings")
    ...
    generate_parser.add_argument("--top-p", type=float, default=0.9, help="Nucleus sampling parameter")
    ...
    translate_parser.add_argument("--src", default="bn", choices=["bn", "en"], help="Source language")
    translate_parser.add_argument("--tgt", default="en", choices=["bn", "en"], help="Target language")
    translate_parser.add_argument("--model", default="bilingual-translate", help="Translation model name")
