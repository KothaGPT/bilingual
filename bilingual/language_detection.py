...
class LanguageDetector:
    ...
    def __init__(self):
        ...
        self.bengali_indicators = [
            'আমি', 'আমার', 'আমাদের', 'তুমি', 'তোমার', 'আপনি', 'আপনার',
            'হ্যাঁ', 'না', 'কি', 'কী', 'কে', 'কোথায়', 'কখন', 'কেন',
            'এটি', 'এই', 'ওই', 'সেই', 'যে', 'যিনি', 'যারা',
            'করা', 'হওয়া', 'যাওয়া', 'আসা', 'দেওয়া', 'নেওয়া',
            'বাংলাদেশ', 'ঢাকা', 'কলকাতা', 'ভারত', 'পাকিস্তান'
        ]

        # Common English words/patterns
        self.english_indicators = [
            'the', 'and', 'for', 'are', 'but', 'not', 'you', 'all', 'can', 'her',
            'was', 'one', 'our', 'had', 'by', 'word', 'but', 'what', 'were', 'we',
            'when', 'your', 'said', 'there', 'use', 'each', 'which', 'their', 'time',
            'hello', 'world', 'computer', 'program', 'language', 'english'
        ]
        ...
        self.bengali_pattern = re.compile(
            f"[{''.join(chr(code) for code in bengali_chars)}]+"
        )
    ...
    def extract_english_text(self, text: str) -> str:
        ...
        return ''.join(char for char in text if not self.is_bengali_char(char) and char.isalnum() or char.isspace())
